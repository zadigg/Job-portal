...
?>
    <link rel="stylesheet" href="CSSJSFONT/JOb list/plugins/css/plugins.css">
                            ...
                            <div class="brows-job-list">
                                <div class="col-md-6 col-sm-6">
                                    <div class="item-fl-box">
                                        <div class="brows-job-company-img">
                                            <a href="job-detail.html"><img src="CSSJSFONT/JOb list/img/com-1.jpg"
                                                    class="img-responsive" alt="" /></a>
                                        </div>
                                        <div class="brows-job-position">
                                            <h3><a href="CheckCompanyProfile.html">Digital Marketing Manager</a></h3>
                                            <p>
                                                <span>Autodesk</span><span class="brows-job-sallery"><i
                                                        class="fa fa-money"></i>$750 - 800</span>
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <div class="brows-job-link">
                                        <a href="Applyjob.html" class="btn btn-default">Apply Now</a>
                                    </div>
                                </div>
                            </div>
