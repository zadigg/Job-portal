...
include('connection/db.php');
  ...
  $job_id=$_GET['edit'];
  $query = mysqli_query($con,"select * from jobs where job_id ='$job_id'");
  while ($row=mysqli_fetch_array($query)) {
    ...
    $City=$row['city'];
    $phone=$row['phone'];
    $Educational_Level=$row['degreelvl'];
...
if (isset($_POST['submit'])) {
    ...
    $jobUpdate = new Admin();
    $jobUpdate->jobEdit($job_name,$role_catagory,$salary,$gender,$address,$region,$city,$phone,$Educational_Level,$experiance,$job_description,$job_id);
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="add_create_job.php">Edit Job</a></li>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <a class="btn btn-primary col-sm-4 col-sm-push-8" href="add_create_job.php">Edit Job</a>
            ...
            <div id="msg"></div>
             ...
             <form action="" method="post" style="margin:3%; padding: 3%;" name="job_form" id="job_form">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $job_name; ?>" name="job_name" id="job_name" class="form-control" placeholder="Enter job Name">
                 </div>
                 ...
                 <div class="form-group">
                    ...
                    <option value="0">Choose type</option>
                        <?php 
                            include('connection/db.php');
                            $sql=mysqli_query($con,"SELECT job_type FROM job_type");
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $salary; ?>" name="salary" id="salary" class="form-control" placeholder="Enter salary">
                 </div>
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $address; ?>" name="address" id="address" class="form-control" placeholder="Enter address">
                 </div>
                 ...
                 <div class="form-group">
                    ...
                    <input type="text"value="<?php echo $City; ?>"  name="city" id="city" class="form-control" placeholder="Enter city">
                 </div>

                 <div class="form-group">
                    <label for="phone">phone</label>
                    <input type="text" value="<?php echo $phone; ?>" name="phone" id="phone" class="form-control" placeholder="Enter phone">
                 </div>
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $experiance; ?>" name="experiance" id="experiance" class="form-control" placeholder="Enter experiance">
                 </div>
     
                 <div class="form-group">
                    <label for="job_description">job description</label>
                    <textarea  name="job_description" id="job_description" class="form-control" cols="30" rows="10" placeholder="Enter job_description"> <?php echo $job_description; ?> </textarea>
                 </div>
                  
                  
                 <input type="hidden" name="job_id" id="job_id" value="<?php echo $_GET['edit']; ?>">      <!-- this helps us to edit -->
                      <div class="form-group">
