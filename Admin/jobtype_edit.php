...
$id=$_GET['edit'];
$query = mysqli_query($con, "select * from job_type where jobtype_id='$id'");
while($row=mysqli_fetch_array($query)){
  $jobtypedata = $row['job_type_name'];
...
if (isset($_POST['submit'])) {
    ...
    $updateCatagory->jobtypeEdit($jobtype,$jobtype_id);
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="catagory.php">Jobtype</a></li>
          <li class="breadcrumb-item"><a href="add_Catagory.php">Jobtype Edit</a></li>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <a class="btn btn-primary col-sm-4 col-sm-push-8" href="add_jobseeker.php">Edit Jobtype</a>
        ...
        <div style="width: 60%; margin-left: 20%; background-color: #F2F4F4;" >
            <div id="msg"></div>
             ...
             <div class="form-group">
                    ...
                    <input type="text"  name="jobtype" id="jobtype" value=" <?php echo $jobtypedata; ?>" class="form-control"  > 
                 </div>
                      ...
                      <input type="hidden" name="jobtype_id" id="jobtype_id" value= " <?php echo $_GET['edit']; ?>">
                      <div class="form-group">
