...
$editJobQuery = new Job();
$returnedEditJob = $editJobQuery->viewManageJob($job_id);
$row = mysqli_fetch_array($returnedEditJob);
...
// echo "<script>alert('$jobName');</script>";
...
if(isset($_POST["submit"])){
  ...
  while($row=mysqli_fetch_array($query)){
    ...
    $query1=mysqli_query($con,"SELECT jobtype_id FROM job_type WHERE job_type_name = '$job_typeString'");

  while($row=mysqli_fetch_array($query1)){
	
	$GLOBALS['job_type_id']=  $row['jobtype_id']; 
  ...
  $employerJobadd = new Employer();
   $employerJobadd->employerEditPostedJob($job_name,$role_cata,$salary,$gender,$address,
                                            $city,$regionFK,$phone,$Educational_Level,$experiance,$job_description,$deadline,$job_id);//-> this helps to call a class function using an that classes object
				...
				<div class="row">
					<div class="col-12">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control" type="text" name="job_name" id="job_name" value="<?php echo $jobName?>"
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control" type="text" name="salary" id="salary" value="<?php echo $salary?>"
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control" type="text" name="gender" id="gender" value="<?php echo $gender?>"
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control" type="text" name="city" id="city" placeholder="hunter2" value="<?php echo $city?>"
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control" type="text" name="experiance" id="experiance" value="<?php echo $experiance?>"
									placeholder="5years">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea name="job_description" id="job_description" value="<?php echo $job_description?>" cols="100%" rows="10"></textarea>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control" type="datetime-local" name="deadline" id="deadline" value="<?php echo $deadline?>"
