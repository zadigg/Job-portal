						...
						<div class="box-body no-padding">
							...
							<table class="table table-striped">
								...
								<tbody>
									<?php 
                                     $roll = 1;
                                     $jobNameFind = new Exam();
                                     $foundJobName = $jobNameFind->findJobName($em_id); 
                                    

									while( $fetchedJobName = mysqli_fetch_array($foundJobName)){
										$user = 0;
                                        $user++;
                                     
                                       $job_id = $fetchedJobName['job_id'];
									...
									<tr>
										<td><?php echo $roll; ?></td>
                                        <td><a href="examView.php?job_id=<?php echo $job_id?>"><?php echo $fetchedJobName['job_name'];?></td></a>
